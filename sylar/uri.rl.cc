...
#line 1 "/data/workspace/origin_sylar/sylar/sylar/uri.rl"
#include "uri.h"
#include <sstream>
...
namespace sylar {
	...
	#line 132 "/data/workspace/origin_sylar/sylar/sylar/uri.rl"
	...
	Uri::ptr Uri::Create(const std::string& uristr) {
		...
		#line 139 "/data/workspace/origin_sylar/sylar/sylar/uri.rl"
		...
		
		{
			...
			ctr467:
			{
				#line 16 "/data/workspace/origin_sylar/sylar/sylar/uri.rl"
				mark = p; }
			{
				#line 103 "/data/workspace/origin_sylar/sylar/sylar/uri.rl"
			...
			ctr474:
			{
				#line 17 "/data/workspace/origin_sylar/sylar/sylar/uri.rl"
				mark = p; }
			{
				#line 42 "/data/workspace/origin_sylar/sylar/sylar/uri.rl"
			...
			ctr489:
			{
				...
				mark = p; }
			{
				#line 27 "/data/workspace/origin_sylar/sylar/sylar/uri.rl"
			...
			{
				#line 77 "/data/workspace/origin_sylar/sylar/sylar/uri.rl"
			...
			ctr38:
			{
				#line 34 "/data/workspace/origin_sylar/sylar/sylar/uri.rl"
			...
			ctr543:
			{
				#line 19 "/data/workspace/origin_sylar/sylar/sylar/uri.rl"
			...
			if ( p == eof )
			{
				switch ( cs ) {
					...
					case 454: 
					{
						#line 109 "/data/workspace/origin_sylar/sylar/sylar/uri.rl"
		...
		#line 143 "/data/workspace/origin_sylar/sylar/sylar/uri.rl"
