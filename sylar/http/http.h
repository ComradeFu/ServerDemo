#ifndef __SYLAR_HTTP_HTTP_HH__
#define __SYLAR_HTTP_HTTP_HH__
//主要是智能指针
#include <memory>
#include <string>
#include <map>
...
private:
    ...
    bool m_close; //1.1 支持 keepalive，所以要解出来
    ...
    //header 是大小写无关的，所以要重载 map 的比较函数
    MapType m_headers;
    //来源比较复杂，有可能是url部分，也有可能是从post来的body部分
    MapType m_params;
    MapType m_cookies;
};
